...
BOT_TOKEN = environ['BOT_TOKEN', '6356386139:AAFgfC5SXJ1Hcj_c-XQcB6uyi7FQd47kdcg']
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://2sonu2monu2:19hwweNfO1syshkZ@cluster0.54u0eag.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "2sonu2monu2")
...
#ai
OPENAI_API = environ.get("OPENAI_API","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")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','Shahilakhtar') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','allmovies_webserieshere') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','SA_update') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','sa.editz_0')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "allmovies_webserieshere") #[ without @ ]

# Url Shortner
URL_MODE = is_enabled((environ.get("URL_MODE","True")), False)
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'linkpays.in') #Always use website url from api section 
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'df4a166033c268c86a7d6588b0ce4c23bf5045e7')
